/**
  Creacion de las herramientas de control para las orden_controller
*/
async function crearOrden(e) {
    ...
    swalWithBootstrapButtons
        .fire({
            ...
            confirmButtonText: "Si, agregar orden",
...
async function editarOrden(e) {
    e.preventDefault();
    var form = document.getElementById("EditarOrden");
    const swalWithBootstrapButtons = Swal.mixin({
        customClass: {
            confirmButton: "btn btn-success",
            cancelButton: "btn btn-danger",
                ...
                fetch("php/orden_controller.php", {
                    ...
                    .then((result) => {
                        if (result == 1) {
                            swalWithBootstrapButtons.fire(
                                "Actualizado!",
                                "La orden ha sido editada en la base de datos.",
                                "success"
                            );
                            form.reset();
                            setTimeout(function() {
...
/**
  Creacion de las herramientas de control para las evidencias
*/
...
/**
  Creacion de las herramientas de control para los servicios
*/
                ...
                fetch("php/servicios_controller.php", {
                    ...
                    .then((result) => {
                        if (result == 1) {
                            swalWithBootstrapButtons.fire(
                                "Agregado!",
                                "El servicio ha sido agregado en la base de datos.",
                                "success"
                            );
                            form.reset();
                            setTimeout(function() {
...
async function editarServicio(e) {
    e.preventDefault();
    var form = document.getElementById("EditServicio");
    const swalWithBootstrapButtons = Swal.mixin({
        customClass: {
            confirmButton: "btn btn-success",
            cancelButton: "btn btn-danger",
                ...
                fetch("php/servicios_controller.php", {
                    ...
                    .then((result) => {
                        if (result == 1) {
                            swalWithBootstrapButtons.fire(
                                "Actualizado!",
                                "El servicio ha sido editado en la base de datos.",
                                "success"
                            );
                            form.reset();
                            setTimeout(function() {
...
/**
  Creacion de las herramientas de control para los trabajador_controller
*/
...
async function editarTrabajador(e) {
    e.preventDefault();
    var form = document.getElementById("EditarTrabajador");
    const swalWithBootstrapButtons = Swal.mixin({
        customClass: {
            confirmButton: "btn btn-success",
            cancelButton: "btn btn-danger",
                ...
                fetch("php/trabajador_controller.php", {
                    ...
                    .then((result) => {
                        if (result == 1) {
                            swalWithBootstrapButtons.fire(
                                "Agregado!",
                                "El trabajador ha sido editado en la base de datos.",
                                "success"
                            );
                            form.reset();
                            setTimeout(function() {
...
/**
  Creacion de las herramientas de control para cliente_controller
*/
...
/**
  Creacion de las herramientas de control para unidades
*/
