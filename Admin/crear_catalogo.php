    ...
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i> Alta de Concepto de Catalogo</h3>
                <div class="row mt">
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <div class="form">
                                <form class="cmxform form-horizontal style-form" id="FormCatalogo">
        ...
        async function crearCatalogo(e) {
            ...
            swalWithBootstrapButtons
                .fire({
                    ...
                    confirmButtonText: "Si, agregar concepto",
