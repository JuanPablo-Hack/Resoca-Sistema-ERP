...
switch ($_POST['accion']) {
    case 'agregar':
        ...
        break;
    case 'editar':
        editar_unidad($_POST['identificador'], $_POST['modelo'], $_POST['ano'], $_POST['color'], $_POST['placas'], $_POST['no_economico'], $_POST['capacidad'], $_POST['tipo_unidad'], $_POST['tipo_combustible'], $_POST['serie'], $_POST['descripcion']);
        break;
    case 'eliminar':
