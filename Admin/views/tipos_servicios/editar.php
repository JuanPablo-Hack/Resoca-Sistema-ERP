...
$sql2 = "SELECT  id,nombre FROM unidades";
$result2 = mysqli_query($conexion, $sql2);
?>
<div class="modal fade" id="Editartipos_servicios<?php echo $mostrar['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Editar tipo de servicio</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success">Editar tipo de servicio</button>
            </div>
            </form>
        </div>
    </div>
