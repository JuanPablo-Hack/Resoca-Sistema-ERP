...
function concepto_edicion($num_conceptos, $arreglo)
{
    switch ($num_conceptos) {
        case 1:
            $porciones = explode(",", $arreglo);
            ...
            echo '<div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Cantidad Recolectada</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" value="' . $porciones[1] . ' " >
                    </div>
                </div>';
            break;
        case 2:
            ...
            echo '<div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Cantidad Recolectada</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" value="' . $porciones[3] . ' " >
                    </div>
                </div>';
            break;
        case 3:
            ...
            echo '<div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Cantidad Recolectada</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="' . $porciones[5] . ' " >
                        </div>
                    </div>';
            break;
        case 4:
            ...
            echo '<div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Cantidad Recolectada</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="' . $porciones[7] . ' " >
                        </div>
                    </div>';
            break;
        case 5:
            ...
            echo '<div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Cantidad Recolectada</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="' . $porciones[9] . ' " >
                        </div>
                    </div>';
            break;
    }
