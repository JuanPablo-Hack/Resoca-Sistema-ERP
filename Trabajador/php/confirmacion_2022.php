...
function confirmarServicio($folio, $nombre, $cargo, $imagenCodificada, $foto, $foto2, $foto3, $foto4)
{
    ...
    $sql = "INSERT INTO confirmar_2022 (id_orden,nombre,cargo,ruta,foto,foto1,foto2,foto3) VALUES ('$folio','$nombre','$cargo','$nombreImagenGuardada','$foto','$foto2','$foto3','$foto4');";
...
function editarconfirmar($id, $folio, $nombre, $cargo, $foto, $foto2, $foto3, $foto4)
{
    include 'conexion.php';
    subir_imagenes_confirmar_imagen($folio);
    $sql = "UPDATE confirmar_2022 SET id_orden = '$folio', nombre = '$nombre', cargo = '$cargo', foto = '$foto', foto1 = '$foto2', foto2 = '$foto3', foto3 = '$foto4' WHERE id = $id";
    $resultado = $conexion->query($sql);
    if ($resultado) {
        echo 1;
    } else {
...
{
    include './conexion.php';
    $sql = "DELETE FROM confirmar_2022 WHERE id=$id";
